...
public class Tuple {
    ...
    {
    	String fields_Des = new String();
		//for(int k=0 ; k<this.num_Fields ; k++){
		
		for(int k=0 ; k< fields.length ; k++)
		{
			
			fields_Des = fields_Des + this.fields[k];
			//System.out.println(this.fields[k]);
			//str_Des = str_Des + this.types[k];
			//System.out.println(this.types[k]);
			//str_Des = str_Des + "[";
			//str_Des = str_Des + this.fields_Name[k];
			//str_Des = str_Des + this.types[k];
			//fields_Des = fields_Des + "]";
			System.out.println(this.fields[k]);
			System.out.println(fields_Des);
